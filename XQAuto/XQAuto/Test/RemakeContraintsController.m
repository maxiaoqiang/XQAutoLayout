...
- (void)viewDidLoad {
    ...
    [self.growingButton addTarget:self action:@selector(oneGrowButtonTaped:) forControlEvents:UIControlEventTouchUpInside];
...
-(void)oneGrowButtonTaped:(UIButton *)sender{
